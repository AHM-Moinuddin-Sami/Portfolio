...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-tl from-[#0088ffc6] to-[#00ffd0] items-center grid md:grid-cols-2 p-4 bg-neutral text-neutral-content">
            ...
            <div className="flex gap-4 justify-center md:place-self-center md:justify-self-end">
