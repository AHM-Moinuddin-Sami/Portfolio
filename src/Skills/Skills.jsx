...
const Skills = () => {
  ...
  const coreSkills = [
    ...
    { name: "Gameplay Systems", icon: "gamefeel.png", glow: "from-fuchsia-400 to-pink-300" },
    { name: "Optimization & Profiling", icon: "profiling.png", glow: "from-orange-400 to-amber-300" },
    { name: "AI & Logic Design", icon: "ai.png", glow: "from-lime-400 to-emerald-300" },
  ];
